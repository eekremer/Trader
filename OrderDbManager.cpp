...
OrderDbManager::OrderDbManager( const QString  &path )
{
...
bool OrderDbManager::isOpen() const
{
...
bool OrderDbManager::createTable()
{
...
bool OrderDbManager::addPerson( const QString&  name )
{
...
bool OrderDbManager::removePerson( const QString&  name )
{
...
void OrderDbManager::printAllPersons() const
{
...
bool OrderDbManager::personExists( const QString&  name ) const
{
...
bool OrderDbManager::removeAllPersons()
{
